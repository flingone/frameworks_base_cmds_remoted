...
#ifndef DIALHANDLER_H_
#define DIALHANDLER_H_
...
class DialHandler: public HttpHandler {
public:
	DialHandler(HTTPSession *session, boost::asio::io_service &ioService);
...
private:
	...
	bool doLaunch(HTTPSession *session, const std::string &appId,
